...
```
* Get the ips of mzworker0.wuriguinee.unir and dmzworker0.wuriguinee.unir
```
ping mzworker0.wuriguinee.unir
ping dmzworker0.wuriguinee.unir
```
* Set **private ip** address of `mzworker0.wuriguinee.unir` and `dmzworker0.wuriguinee.unir` in `group_vars/all.yml`:

```
clusters:
  mz:
    any_node_ip: '<mzworker0.wuriguinee.unir ip>'

clusters:
  dmz:
    any_node_ip: '<dmzworker0.wuriguinee.unir ip>'
```
### Network interface
