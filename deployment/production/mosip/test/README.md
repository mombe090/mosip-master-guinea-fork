...
```
* Get the ips of test_mzworker0.inu.gov.gn and test_dmzworker0.inu.gov.gn
```
ping test_mzworker0.inu.gov.gn
ping test_dmzworker0.inu.gov.gn
```
* Set **private ip** address of `test_mzworker0.inu.gov.gn` and `test_dmzworker0.inu.gov.gn` in `group_vars/all.yml`:

```
clusters:
  mz:
    any_node_ip: '<test_mzworker0.inu.gov.gn ip>'

clusters:
  dmz:
    any_node_ip: '<test_dmzworker0.inu.gov.gn ip>'
```
### Network interface
